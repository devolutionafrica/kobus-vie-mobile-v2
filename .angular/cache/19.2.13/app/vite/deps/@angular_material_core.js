...
__publicField(__MatInternalFormField, "ɵfac", function _MatInternalFormField_Factory(__ngFactoryType__) {
...
__publicField(_MatLine, "ɵfac", function MatLine_Factory(__ngFactoryType__) {
...
__publicField(_MatLineModule, "ɵfac", function MatLineModule_Factory(__ngFactoryType__) {
...
__publicField(AnimationCurves, "STANDARD_CURVE", "cubic-bezier(0.4,0.0,0.2,1)");
__publicField(AnimationCurves, "DECELERATION_CURVE", "cubic-bezier(0.0,0.0,0.2,1)");
__publicField(AnimationCurves, "ACCELERATION_CURVE", "cubic-bezier(0.4,0.0,1,1)");
__publicField(AnimationCurves, "SHARP_CURVE", "cubic-bezier(0.4,0.0,0.6,1)");
var AnimationDurations = class {
};
__publicField(AnimationDurations, "COMPLEX", "375ms");
__publicField(AnimationDurations, "ENTERING", "225ms");
__publicField(AnimationDurations, "EXITING", "195ms");
