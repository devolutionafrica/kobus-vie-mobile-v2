...
__publicField(_MatSort, "ɵfac", function MatSort_Factory(__ngFactoryType__) {
...
__publicField(_MatSortHeaderIntl, "ɵfac", function MatSortHeaderIntl_Factory(__ngFactoryType__) {
...
var _MatSortHeader = class _MatSortHeader {
  ...
  ngOnDestroy() {
    ...
    (_a = this._renderChanges) == null ? void 0 : _a.unsubscribe();
    if (this._sortButton) {
      (_b = this._ariaDescriber) == null ? void 0 : _b.removeDescription(this._sortButton, this._sortActionDescription);
    }
  }
...
__publicField(_MatSortHeader, "ɵfac", function MatSortHeader_Factory(__ngFactoryType__) {
...
__publicField(_MatSortModule, "ɵfac", function MatSortModule_Factory(__ngFactoryType__) {
