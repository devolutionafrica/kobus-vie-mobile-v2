...
__publicField(__IdGenerator, "ɵfac", function _IdGenerator_Factory(__ngFactoryType__) {
...
var Typeahead = class {
  ...
  constructor(initialItems, config) {
    const typeAheadInterval = typeof (config == null ? void 0 : config.debounceInterval) === "number" ? config.debounceInterval : DEFAULT_TYPEAHEAD_DEBOUNCE_INTERVAL_MS;
    if (config == null ? void 0 : config.skipPredicate) {
  ...
  _setupKeyHandler(typeAheadInterval) {
    this._letterKeyStream.pipe(tap((letter) => this._pressedLetters.push(letter)), debounceTime(typeAheadInterval), filter(() => this._pressedLetters.length > 0), map(() => this._pressedLetters.join("").toLocaleUpperCase())).subscribe((inputString) => {
      ...
      for (let i = 1; i < this._items.length + 1; i++) {
        ...
        if (!((_a = this._skipPredicateFn) == null ? void 0 : _a.call(this, item)) && ((_b = item.getLabel) == null ? void 0 : _b.call(item).toLocaleUpperCase().trim().indexOf(inputString)) === 0) {
...
var ListKeyManager = class {
  ...
  cancelTypeahead() {
    var _a;
    (_a = this._typeahead) == null ? void 0 : _a.reset();
    return this;
  }
  /**
    ...
    switch (keyCode) {
      ...
      default:
        if (isModifierAllowed || hasModifierKey(event, "shiftKey")) {
          (_a = this._typeahead) == null ? void 0 : _a.handleKey(event);
        }
        return;
    }
    (_b = this._typeahead) == null ? void 0 : _b.reset();
  ...
  updateActiveItem(item) {
    ...
    (_a = this._typeahead) == null ? void 0 : _a.setCurrentSelectedItemIndex(index);
  }
  ...
  _itemsChanged(newItems) {
    var _a, _b;
    (_a = this._typeahead) == null ? void 0 : _a.setItems(newItems);
    const activeItem = this._activeItem();
    if (activeItem) {
      const newIndex = newItems.indexOf(activeItem);
      if (newIndex > -1 && newIndex !== this._activeItemIndex) {
        this._activeItemIndex = newIndex;
        (_b = this._typeahead) == null ? void 0 : _b.setCurrentSelectedItemIndex(newIndex);
      }
    }
  }
};
...
var TreeKeyManager = class {
  ...
  _initializeFocus() {
    ...
    if (activeItem.makeFocusable) {
      (_a = this._activeItem) == null ? void 0 : _a.unfocus();
      this._activeItemIndex = activeIndex;
      this._activeItem = activeItem;
      (_b = this._typeahead) == null ? void 0 : _b.setCurrentSelectedItemIndex(activeIndex);
  ...
  constructor(items, config) {
    if (items instanceof QueryList) {
      ...
      items.changes.subscribe((newItems) => {
        ...
        (_a = this._typeahead) == null ? void 0 : _a.setItems(this._items);
  ...
  destroy() {
    var _a;
    this._typeaheadSubscription.unsubscribe();
    (_a = this._typeahead) == null ? void 0 : _a.destroy();
    this.change.complete();
  }
  /**
  ...
  focusItem(itemOrIndex, options = {}) {
    var _a, _b, _c;
    (_a = options.emitChangeEvent) != null ? _a : options.emitChangeEvent = true;
    ...
    const previousActiveItem = this._activeItem;
    this._activeItem = activeItem != null ? activeItem : null;
    this._activeItemIndex = index;
    (_b = this._typeahead) == null ? void 0 : _b.setCurrentSelectedItemIndex(index);
    (_c = this._activeItem) == null ? void 0 : _c.focus();
    previousActiveItem == null ? void 0 : previousActiveItem.unfocus();
  ...
  _updateActiveItemIndex(newItems) {
    ...
    if (newIndex > -1 && newIndex !== this._activeItemIndex) {
      this._activeItemIndex = newIndex;
      (_a = this._typeahead) == null ? void 0 : _a.setCurrentSelectedItemIndex(newIndex);
    }
  }
  ...
  _isItemDisabled(item) {
    var _a;
    return typeof item.isDisabled === "boolean" ? item.isDisabled : (_a = item.isDisabled) == null ? void 0 : _a.call(item);
  }
  ...
  _activateCurrentItem() {
    var _a;
    (_a = this._activeItem) == null ? void 0 : _a.activate();
  }
};
...
//# sourceMappingURL=chunk-5PUA6DZ4.js.map
